...
/*
final List<Map<String, dynamic>> motorMilestones = [
  {"label": "القدرة على الرضاعة الطبيعية", "isChecked": false},
  {"label": "القدرة على وضع اليدين في الفم", "isChecked": false},
  {"label": "القدرة على فتح وإغلاق قبضات ايده", "isChecked": false},
  {"label": "تحريك الذراعين والساقين عند الشعور بالحماس", "isChecked": false},
  {"label": "رفع الرأس عند الاستلقاء على البطن", "isChecked": false},
  {"label": "الدفع بالذراعين عند الاستلقاء على البطن", "isChecked": false},
];
final List<Map<String, dynamic>> sensoryMilestones = [
  {
    "label": "القدرة على الهدوء مع الهز واللمس والأصوات الهادئة",
    "isChecked": false
  },
  ...
  {
    "label": "متابعة لعبة متحركة من جانب إلى جانب عند الاستلقاء على الظهر",
    "isChecked": false
  },
];
final List<Map<String, dynamic>> communicationMilestones = [
  {"label": "إصدار أصوات ابتسامة", "isChecked": false},
  {
    "label": "البكاء بطرق مختلفة للاحتياجات المختلفة (جوع، تعب)",
    "isChecked": false
...
final List<Map<String, dynamic>> feedingMilestones = [
  {
    "label":
        'شرب من 59 الي 172ملليليتر من السوائل لكل وجبة، 6 مرات في اليوم "على الاقل"',
    "isChecked": false
  ...
  {"label": "الامتصاص والبلع بشكل جيد أثناء الرضاعة", "isChecked": false},
  {"label": "تحريك اللسان للأمام والخلف للامتصاص", "isChecked": false},
];
